...
class ApproveRequests extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            ...
            'message' => "You have successfully " . $requestStatusText . " a request for " .$requestTypeText . ". Your informations are now visible to the requester" ,
        ];
    }
    /**
