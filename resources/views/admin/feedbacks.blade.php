...
@section('script')
    ...
    <script>
        ...
        $('#deleteFeedbackForm').submit(function(e) {
            ...
            axios.delete("{{ url('admin/feedbacks') }}/" + feedbackId, {
                    data: {
                        '_token': '{{ csrf_token() }}',
                    }
                })
        ...
        $('#replyFeedbackForm').submit(function(e) {
            ...
            axios.post("{{ route('admin.replyFeedback') }}", formData)
                .then(function(response) {
                    alert(response.data.success);
        ...
        $('#feedbackList').on('click', '.toggle-display', function(e) {
            ...
            axios.post("{{ route('admin.toggleDisplay') }}", {
                    _token: '{{ csrf_token() }}',
