                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img src="@if (Auth::user()->avatar != '') {{ URL::asset('images/' . Auth::user()->avatar) }}@else{{ URL::asset('images/default-avatar.jpg') }} @endif"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="text" class="form-control" id="igUsername" placeholder="Username"
                            value="">
                    </div>
                    <div class="mb-3 d-flex">
                        <div class="avatar-xs d-block flex-shrink-0 me-3">
                        ...
                        <input type="text" class="form-control" id="twitterUsername" placeholder="Username"
                            value="">
                    </div>
                    <div class="mb-3 d-flex">
                        <div class="avatar-xs d-block flex-shrink-0 me-3">
                        ...
                        <input type="text" class="form-control" id="tiktokUsername" placeholder="Username"
                            value="">
                    </div>
                </div>
            </div>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" minlength="5" maxlength="6"
                                                id="postcodeInput" placeholder="Enter postcode" value="">
                                        </div>
                                    </div>
                                    <!--end col-->
                        ...
                        <div class="tab-pane" id="privacy" role="tabpanel">
                            ...
                            <div>
                                ...
                                <div>
                                    <input type="password" class="form-control" id="passwordInput" placeholder="Enter your password" value="" style="max-width: 265px;">
                                </div>
