...
Route::get('/admin', [App\Http\Controllers\HomeController::class, 'adminIndex'])->middleware('auth', 'role:admin')->name('admin.index');
...
// Route::get('logout', [App\Http\Controllers\HomeController::class, 'showLogout'])->name('logout.log');
