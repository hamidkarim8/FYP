<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.transactions'); ?>
                ...
                <table class="table align-middle table-nowrap" id="customerTable">
                    ...
                    <tbody class="list form-check-all">
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/btc.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    BTC
                                </div>
                            </td>
                            ...
                            <td class="status">
                                <span class="badge badge-soft-warning fs-11"><i class="ri-time-line align-bottom"></i>
                                    Processing</span>
                            </td>
                        </tr>
                        <!--end tr-->
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/eur.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    EUR
                                </div>
                            </td>
                            ...
                            <td class="status">
                                <span class="badge badge-soft-danger fs-11"><i
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/gbp.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    GBP
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/jpy.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    JPY
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/xrp.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    XRP
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/xpm.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    XPM
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="currency_name">
                                <div class="d-flex align-items-center">
                                    <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ppt.svg')); ?>" alt=""
                                        class="avatar-xxs me-2 rounded-circle shadow">
                                    PPT
                                </div>
                            </td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-crypto-transactions.blade.php ENDPATH**/ ?>