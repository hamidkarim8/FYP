                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row g-1 mb-3">
                                                <div class="col-lg-6">
                                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-03.jpg')); ?>" alt="" class="img-fluid rounded">
                                                    <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-5.gif')); ?>" alt="" class="img-fluid rounded mt-1">
                                                </div><!--end col-->
                                                <div class="col-lg-6">
                                                    <img src="<?php echo e(URL::asset('assets/images/nft/gif/img-2.gif')); ?>" alt="" class="img-fluid rounded mb-1">
                                                    <img src="<?php echo e(URL::asset('assets/images/nft/img-05.jpg')); ?>" alt="" class="img-fluid rounded">
                                                </div><!--end col-->
                                            </div><!--end row-->
                                            <a href="#!" class="float-end"> View All <i class="ri-arrow-right-line align-bottom"></i></a>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/nft-landing.blade.php ENDPATH**/ ?>