                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#contactInitiated2"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/brands/github.png')); ?>" alt=""
                                    class="avatar-xs rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#needsIdentified6"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-6.png')); ?>" alt=""
                                    class="avatar-xs rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#meetingArranged1"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-5.png')); ?>" alt=""
                                    class="avatar-xs rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted2" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/brands/slack.png')); ?>" alt="" class="avatar-xs rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse" href="#offerAccepted5" role="button"
                            ...
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/companies/img-3.png')); ?>" alt=""
                                    class="avatar-xs rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-crm-deals.blade.php ENDPATH**/ ?>