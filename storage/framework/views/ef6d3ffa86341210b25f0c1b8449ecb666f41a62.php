<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.scrollbar'); ?>
                                ...
                                <div data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="primary"
                                    ...
                                    <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                <span
                                                    class="avatar-title bg-soft-info text-info rounded-circle fs-16 shadow">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>"
                                                    class="rounded-circle img-fluid shadow" alt="user-pic">
                                            </div>
                                            <div class="flex-grow-1 text-muted">
                                    ...
                                    <a href="#!" class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-xs me-3">
                                                <span
                                                    class="avatar-title bg-soft-danger text-danger rounded-circle fs-16 shadow">
                                        ...
                                        <a href="#" class="list-group-item text-muted py-3">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-shrink-0 align-self-center me-3">
                                                    <div class="avatar-xs">
                                                        <span
                                                            class="avatar-title rounded-circle bg-light text-primary shadow">
                                                            M
                                                        </span>
                                                    </div>
                                                </div>
                            ...
                            <div class="mx-n3">
                                <div data-simplebar data-simplebar-auto-hide="false" data-simplebar-track="warning"
                                    ...
                                    <div class="d-flex align-items-center py-3">
                                        ...
                                        <div class="flex-shrink-0 ms-2">
                                            <button type="button" class="btn btn-sm btn-outline-success shadow-none"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/advance-ui-scrollbar.blade.php ENDPATH**/ ?>