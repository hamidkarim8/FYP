<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.typography'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <h1 class="mb-3">h1. Bootstrap heading <small class="text-muted">Semibold 2.03125rem
                                (32.5px)</small></h1>
                        <h2 class="mb-3">h2. Bootstrap heading <small class="text-muted">Semibold 1.625rem
                                (26px)</small></h2>
                        ...
                        <h5 class="mb-3">h5. Bootstrap heading <small class="text-muted">Semibold 1.01563rem
                                (16.25px)</small></h5>
                        <h6 class="mb-1">h6. Bootstrap heading <small class="text-muted">Semibold 0.8125rem
                                (13px)</small></h6>
                    </div>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Traditional heading elements are designed to work best in the meat of your
                        page content.</p>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row gy-4">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    class="blockquote custom-blockquote blockquote-outline blockquote-primary rounded shadow mb-0">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    class="blockquote custom-blockquote blockquote-outline blockquote-secondary rounded shadow mb-0">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    class="blockquote custom-blockquote blockquote-outline blockquote-success rounded shadow mb-0">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    class="blockquote custom-blockquote blockquote-outline blockquote-info rounded shadow mb-0">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    class="blockquote custom-blockquote blockquote-outline blockquote-danger rounded shadow mb-0">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    class="blockquote custom-blockquote blockquote-outline blockquote-warning rounded shadow mb-0">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <blockquote
                                    class="blockquote custom-blockquote blockquote-outline blockquote-dark rounded shadow mb-0">
...
&lt;/div&gt;</code></pre>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div>
                            <p class="text-muted">Use <code>text-break</code> class to prevent long strings of text
                                from breaking your components' layout.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>fs-1</code>, <code>fs-2</code>, <code>fs-3</code>,
                        <code>fs-4</code>, <code>fs-5</code>, or <code>fs-6</code>, class to change the font-size
                        respectively.</p>
                    <div class="live-preview">
...
<code>&lt;p class=&quot;fst-normal mb-0&quot;&gt;Text with normal font style&lt;/p&gt;</code></pre>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>lh-</code> with modifier class to change the line height of an
                        element.</p>

                    <div class="live-preview">
                        <p class="lh-1">This is a long paragraph written to show how the line-height of an
                        ...
                        <p class="lh-sm">This is a long paragraph written to show how the line-height of an
                            element is affected by our utilities. Classes are applied to the element itself or sometimes the
                            parent element. These classes can be customized as needed with our utility API.</p>
                        <p class="lh-base">This is a long paragraph written to show how the line-height of an
                            element is affected by our utilities. Classes are applied to the element itself or sometimes the
                            parent element.</p>
                        <p class="lh-lg mb-0">This is a long paragraph written to show how the line-height of an
                            element is affected by our utilities. Classes are applied to the element itself or sometimes the
                            parent element.</p>
                    </div>
                    ...
                    <div class="d-none code-view">
                        <pre
                            class="language-markup"><code>&lt;p class=&quot;lh-1&quot;&gt;This is a long paragraph written to show how the line-height of an element is affected by our utilities. Classes are applied to the element itself or sometimes the parent element. These classes can be customized as needed with our utility API.&lt;/p&gt;</code>
        ...
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-none code-view">
                        <pre
                            class="language-markup"><code>&lt;p class=&quot;text-decoration-underline&quot;&gt;This text has a line underneath it.&lt;/p&gt;</code>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>clearfix</code> class to clear/set floated content within a
                        container.</p>
                    <div class="live-preview">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/ui-typography.blade.php ENDPATH**/ ?>