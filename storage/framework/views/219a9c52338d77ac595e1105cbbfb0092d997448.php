                ...
                <div class="live-preview">
                    <div>
                        <div>
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded shadow" alt="rounded">
                                    <p><code>.rounded</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-top shadow" alt="rounded-top">
                                    <p><code>.rounded-top</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-end shadow" alt="rounded-end">
                                    <p><code>.rounded-end</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-bottom shadow" alt="rounded-bottom">
                                    <p><code>.rounded-bottom</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-start shadow" alt="rounded-start">
                                    <p><code>.rounded-start</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-md rounded-circle shadow" alt="rounded-circle">
                                ...
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" class="avatar-md w-auto rounded-pill shadow" alt="rounded-pill">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-4">
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-0 shadow" alt="rounded-0">
                                    <p><code>.rounded-0</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-1 shadow" alt="rounded-1">
                                    <p><code>.rounded-1</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-2 shadow" alt="rounded-2">
                                    <p><code>.rounded-2</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-3 shadow" alt="rounded-3">
                                    <p><code>.rounded-3</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-4" alt="rounded-4">
                                    <p><code>.rounded-4</code></p>
                                </div>
                                <div class="text-center">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-1.jpg')); ?>" class="avatar-md rounded-5" alt="rounded-5">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/ui-utilities.blade.php ENDPATH**/ ?>