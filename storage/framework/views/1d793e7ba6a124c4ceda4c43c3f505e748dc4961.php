                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="<?php echo e(URL::asset('/apps-invoices-details')); ?>" class="btn btn-success btn-sm"><i
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="<?php echo e(URL::asset('/apps-ecommerce-product-details')); ?>"
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0 vstack gap-3">
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-sm rounded shadow">
                                </div>
                                <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-ecommerce-order-details.blade.php ENDPATH**/ ?>