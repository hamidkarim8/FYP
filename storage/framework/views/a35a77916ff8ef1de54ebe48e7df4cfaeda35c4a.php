<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.timeline'); ?>
                    ...
                    <div class="timeline-item left">
                        ...
                        <div class="content">
                            ...
                            <div class="avatar-group mb-2">
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                ...
                                <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip"
                                    data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="more">
                                    <div class="avatar-xs">
                    ...
                    <div class="timeline-item left">
                        ...
                        <div class="content">
                            ...
                            <div class="row border border-dashed rounded gx-2 p-2">
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-4.jpg')); ?>" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                                <div class="col-3">
                                    <img src="<?php echo e(URL::asset('assets/images/small/img-6.jpg')); ?>" alt="" class="img-fluid rounded shadow">
                                </div>
                                <!--end col-->
                            </div>
                            <!--end row-->
                    ...
                    <div class="timeline-item right">
                        ...
                        <div class="content">
                            <h5>New ticket received <span
                                    class="badge bg-soft-success text-success fs-10 align-middle ms-1">Completed</span></h5>
                        ...
                        <div class="row timeline-right">
                            ...
                            <div class="col-12">
                                <div class="timeline-box shadow">
                                    <div class="timeline-text">
                                        <h5>Trip planning</h5>
                                        <p class="text-muted">In the trip planner, keep only one or two activities in a
                                            day if the purpose of the trip is to relax and take it easy during the vacation
                                            :</p>
                                        <div class="row border border-dashed rounded gx-2 p-2">
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('assets/images/small/img-7.jpg')); ?>"
                                                        alt="" class="img-fluid rounded shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>"
                                                        alt="" class="img-fluid rounded shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('assets/images/small/img-10.jpg')); ?>"
                                                        alt="" class="img-fluid rounded shadow"></a>
                                            </div>
                                            <!--end col-->
                                            <div class="col-3">
                                                <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('assets/images/small/img-9.jpg')); ?>"
                                                        alt="" class="img-fluid rounded shadow"></a>
                                            </div>
                                            <!--end col-->
                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/pages-timeline.blade.php ENDPATH**/ ?>