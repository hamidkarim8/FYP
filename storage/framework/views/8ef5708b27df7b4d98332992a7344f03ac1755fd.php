            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="<?php echo e(URL::asset('/pages-pricing')); ?>" class="text-reset text-decoration-underline"><b>Upgrade</b></a>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-end">
                        <div class="col-sm-8">
                            <div class="p-3">
                                ...
                                <div class="mt-3">
                                    <a href="<?php echo e(URL::asset('/pages-pricing')); ?>" class="btn btn-success">Upgrade
                                        Account!</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-8">
                            <div class="p-3">
                                <p class="fs-16 lh-base text-white">Upgrade your plan from a <span
                                        ...
                                        trial</span>, to ‘Premium Plan’ <i class="mdi mdi-arrow-right"></i></p>
                                <div class="mt-3">
                                    <a href="<?php echo e(URL::asset('/pages-pricing')); ?>" class="btn btn-info">Upgrade
                                        Account!</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="alert alert-warning border-0 rounded-top rounded-0 m-0 d-flex align-items-center"
                        ...
                        <div class="flex-shrink-0">
                            <a href="<?php echo e(URL::asset('/pages-pricing')); ?>" class="text-reset text-decoration-underline"><b>Get Free
                                    Gift</b></a>
                        </div>
                    </div>
                    <div class="d-flex p-3">
                        ...
                        <div>
                            ...
                            <div class="mt-3">
                                <a href="<?php echo e(URL::asset('/pages-pricing')); ?>" class="btn btn-secondary">Get a Free
                                    Gift</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-evenly">
                        <p class="text-muted mb-0"><i
                                class="mdi mdi-numeric-3-circle text-success fs-18 align-middle me-2 rounded-circle shadow"></i>Completed
                        </p>
                        <p class="text-muted mb-0"><i
                                class="mdi mdi-numeric-0-circle text-info fs-18 align-middle me-2 rounded-circle shadow"></i>In
                            Progress</p>
                        <p class="text-muted mb-0"><i
                                class="mdi mdi-numeric-8-circle text-primary fs-18 align-middle me-2 rounded-circle shadow"></i>To
                            Do</p>
                    </div>
                </div>
                <div class="progress animated-progress bg-soft-primary rounded-bottom rounded-0" style="height: 6px;">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-evenly">
                        <p class="text-muted mb-0"><i
                                class="mdi mdi-numeric-10-circle text-success fs-18 align-middle me-2 rounded-circle shadow"></i>Completed
                        </p>
                        <p class="text-muted mb-0"><i
                                class="mdi mdi-numeric-3-circle text-info fs-18 align-middle me-2 rounded-circle shadow"></i>In
                            Progress</p>
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h6 class="mb-1">Today offers by <a
                                                    href="<?php echo e(URL::asset('/apps-ecommerce-seller-details')); ?>"
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div id="color_heatmap"
                        data-colors='["--vz-info", "--vz-success", "--vz-primary", "--vz-warning", "--vz-danger"]'
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-TESTING\resources\views/widgets.blade.php ENDPATH**/ ?>