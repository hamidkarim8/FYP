                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="alert alert-primary alert-dismissible alert-outline shadow fade show"
                                    role="alert">
                                ...
                                <div class="alert alert-secondary  alert-dismissible alert-outline shadow fade show"
                                    role="alert">
                                ...
                                <div class="alert alert-success alert-dismissible alert-outline shadow fade show"
                                    role="alert">
                                ...
                                <div class="alert alert-danger alert-dismissible alert-outline shadow fade show mb-xl-0"
                                    role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="alert alert-warning alert-dismissible alert-outline shadow fade show"
                                    role="alert">
                                ...
                                <div class="alert alert-info alert-dismissible alert-outline shadow fade show"
                                    role="alert">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible alert-outline shadow fade show mb-0"
                                    role="alert">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-border-left alert-dismissible fade shadow show"
                                    role="alert">
                                ...
                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary alert-border-left alert-dismissible fade shadow show"
                                    role="alert">
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-border-left alert-dismissible fade shadow show mb-xl-0"
                                    role="alert">
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-border-left alert-dismissible fade shadow show mb-0"
                                    role="alert">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-dismissible alert-solid alert-label-icon shadow fade show"
                                    role="alert">
                                ...
                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary alert-dismissible alert-solid alert-label-icon shadow fade show"
                                    role="alert">
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-dismissible alert-solid alert-label-icon shadow fade show mb-xl-0"
                                    role="alert">
                            ...
                            <div class="col-xl-6">
                                <h6>Warning Alert</h6>
                                <div class="alert alert-warning alert-dismissible alert-solid alert-label-icon shadow fade show"
                                    role="alert">
                                ...
                                <h6>Info Alert</h6>
                                <div class="alert alert-info alert-dismissible alert-solid alert-label-icon shadow fade show"
                                    role="alert">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-dismissible alert-solid alert-label-icon shadow fade show"
                                    role="alert">
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible alert-solid alert-label-icon shadow fade show mb-0"
                                    role="alert">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-dismissible alert-additional shadow fade show"
                                    role="alert">
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-dismissible alert-additional shadow fade show mb-xl-0"
                                    role="alert">
                                    <div class="alert-body">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Success Alert</h6>
                                <div class="alert alert-success alert-dismissible alert-additional shadow fade show"
                                    role="alert">
                                    <div class="alert-body">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                ...
                                <h6>Warning Alert</h6>
                                <div class="alert alert-warning alert-dismissible alert-additional shadow fade show mb-0"
                                    role="alert">
                                    <div class="alert-body">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                    ...
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary alert-top-border alert-dismissible shadow fade show"
                                    role="alert">
                                    <i
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-top-border alert-dismissible shadow fade show mb-xl-0"
                                    role="alert">
                                    <i
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-dismissible alert-label-icon label-arrow shadow fade show"
                                    role="alert">
                                    <i class="ri-user-smile-line label-icon"></i><strong>Primary</strong> -
                                ...
                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary alert-dismissible alert-label-icon label-arrow shadow fade show"
                                    role="alert">
                                    <i class="ri-check-double-line label-icon"></i><strong>Secondary</strong> -
                                    Label icon
                                    arrow alert
                                ...
                                <h6>Success Alert</h6>
                                <div class="alert alert-success alert-dismissible alert-label-icon label-arrow shadow fade show"
                                    role="alert">
                                    <i class="ri-notification-off-line label-icon"></i><strong>Success</strong>
                                    - Label
                                    icon arrow alert
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-dismissible alert-label-icon label-arrow shadow fade show mb-xl-0"
                                    role="alert">
                                    <i class="ri-error-warning-line label-icon"></i><strong>Danger</strong>
                                    - Label
                                    icon arrow alert
                            ...
                            <div class="col-xl-6">
                                <h6>Warning Alert</h6>
                                <div class="alert alert-warning alert-dismissible alert-label-icon label-arrow shadow fade show"
                                    role="alert">
                                ...
                                <h6>info Alert</h6>
                                <div class="alert alert-info alert-dismissible alert-label-icon label-arrow shadow fade show"
                                    role="alert">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-dismissible alert-label-icon label-arrow shadow fade show"
                                    role="alert">
                                    <i class="ri-mail-line label-icon"></i><strong>Light</strong>
                                    - Label icon arrow alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible alert-label-icon label-arrow shadow fade show mb-0"
                                    role="alert">
                                    <i class="ri-refresh-line label-icon"></i><strong>Dark</strong>
                                    - Label icon arrow alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
                                <div class="alert alert-primary alert-dismissible alert-label-icon rounded-label shadow fade show"
                                    role="alert">
                                    <i class="ri-user-smile-line label-icon"></i><strong>Primary</strong> -
                                    Rounded label alert
                                    <button type="button" class="btn-close" data-bs-dismiss="alert"
                                ...
                                <h6>Secondary Alert</h6>
                                <div class="alert alert-secondary alert-dismissible alert-label-icon rounded-label shadow fade show"
                                    role="alert">
                                    <i class="ri-check-double-line label-icon"></i><strong>Secondary</strong>
                                    - Rounded
                                    label alert
                                ...
                                <h6>Success Alert</h6>
                                <div class="alert alert-success alert-dismissible alert-label-icon rounded-label shadow fade show"
                                    role="alert">
                                    <i class="ri-notification-off-line label-icon"></i><strong>Success</strong>
                                    - Rounded
                                    label alert
                                ...
                                <h6>Danger Alert</h6>
                                <div class="alert alert-danger alert-dismissible alert-label-icon rounded-label shadow fade show mb-xl-0"
                                    role="alert">
                                    <i class="ri-error-warning-line label-icon"></i><strong>Danger</strong>
                                    - Rounded
                                    label alert
                            ...
                            <div class="col-xl-6">
                                ...
                                <h6>Light Alert</h6>
                                <div class="alert alert-light alert-dismissible alert-label-icon rounded-label shadow fade show"
                                    role="alert">
                                    <i class="ri-mail-line label-icon"></i><strong>Light</strong> -
                                    Rounded label
                                    alert
                                ...
                                <h6>Dark Alert</h6>
                                <div class="alert alert-dark alert-dismissible alert-label-icon rounded-label shadow fade show mb-0"
                                    role="alert">
                                    <i class="ri-refresh-line label-icon"></i><strong>Dark</strong> -
                                    Rounded label
                                    alert
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-TESTING\resources\views/ui-alerts.blade.php ENDPATH**/ ?>