            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="apps-calendar" class="nav-link"><?php echo app('translator')->get('translation.calendar'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="apps-file-manager" class="nav-link"> <span> <?php echo app('translator')->get('translation.file-manager'); ?></span> <span class="badge badge-pill bg-danger"><?php echo app('translator')->get('translation.new'); ?></span></a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="mdi mdi-view-carousel-outline"></i> <span><?php echo app('translator')->get('translation.layouts'); ?>
                        </span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="layouts-vertical-hovered" class="nav-link" target="_blank"><?php echo app('translator')->get('translation.hovered'); ?>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="icons-remix" class="nav-link"><?php echo app('translator')->get('translation.remix'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-boxicons" class="nav-link"><?php echo app('translator')->get('translation.boxicons'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-materialdesign" class="nav-link"><?php echo app('translator')->get('translation.material-design'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-lineawesome" class="nav-link"><?php echo app('translator')->get('translation.line-awesome'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-feather" class="nav-link"><?php echo app('translator')->get('translation.feather'); ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="icons-crypto" class="nav-link"> <span><?php echo app('translator')->get('translation.crypto-svg'); ?></span> <span class="badge badge-pill bg-danger"><?php echo app('translator')->get('translation.new'); ?></span></a>
                            </li>
                        </ul>
                    </div>
                </li>
