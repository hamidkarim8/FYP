                    ...
                    <div class="table-responsive table-card">
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    <td class="order_date">02 Jan, 2022 <small class="text-muted">03:45PM</small>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Bitcoin (BTC)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="status"><span
                                            class="badge badge-soft-success text-uppercase">Successful</span></td>
                                </tr>
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">27 Dec, 2021 <small class="text-muted">02:47PM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Ethereum (ETH)</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="status"><span
                                            class="badge badge-soft-danger text-uppercase">Cancelled</span></td>
                                </tr>
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">19 Dec, 2021 <small class="text-muted">10:24AM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Monero (XMR)</a>
                                        </div>
                                    </td>
                                    <td class="type text-danger">Sell</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">19 Dec, 2021 <small class="text-muted">11:20AM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/mkr.svg')); ?>" alt=""
                                                    class="avatar-xxs shadow rounded-circle" />
                                            </div>
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Maker (MKR)</a>
                                        </div>
                                    </td>
                                    <td class="type text-success">Buy</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">11 Dec, 2021 <small class="text-muted">02:47PM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/yfi.svg')); ?>" alt=""
                                                    class="avatar-xxs shadow rounded-circle" />
                                            </div>
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Yearn.finance (YFI)</a>
                                        </div>
                                    </td>
                                    <td class="type text-success">Buy</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">05 Dec, 2021 <small class="text-muted">09:20AM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">28 Nov, 2021 <small class="text-muted">11:42AM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td class="currency_name">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Litecoin (LTC)</a>
                                        </div>
                                    </td>
                                    <td class="type text-success">Buy</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">19 Nov, 2021 <small class="text-muted">03:36PM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td class="currency_name">
                                ...
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">27 Oct, 2021 <small class="text-muted">03:36PM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td class="currency_name">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/dash.svg')); ?>" alt=""
                                                    class="avatar-xxs shadow rounded-circle" />
                                            </div>
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Dash (DASH)</a>
                                        </div>
                                    </td>
                                    <td class="type text-success">Buy</td>
                                ...
                                <tr>
                                    ...
                                    <td class="currency_name">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Neo (NEO)</a>
                                        </div>
                                    </td>
                                    <td class="type text-danger">Sell</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">21 Oct, 2021 <small class="text-muted">11:45AM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td class="currency_name">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/mln.svg')); ?>" alt=""
                                                    class="avatar-xxs shadow rounded-circle" />
                                            </div>
                                            <a href="javascript:void(0);"
                                                class="currency_name flex-grow-1 ms-2 text-body">Enzyme (MLN)</a>
                                        </div>
                                    </td>
                                    <td class="type text-danger">Sell</td>
                                ...
                                <!--end tr-->
                                <tr>
                                    <td class="order_date">24 Sep, 2021 <small class="text-muted">02:32AM</small>
                                    </td>
                                    <td class="id" style="display:none;"><a href="javascript:void(0);"
                                            class="fw-medium link-primary">#VZ001</a></td>
                                    <td class="currency_name">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-crypto-orders.blade.php ENDPATH**/ ?>