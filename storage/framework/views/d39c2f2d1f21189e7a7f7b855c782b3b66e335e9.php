<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.placeholders'); ?>
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-lg-5 col-sm-6">
                                        <div class="card" aria-hidden="true">
                                            <img src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" class="card-img-top"
                                                alt="card dummy img">
                                            <div class="card-body">
    ...
    <div class="row">
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>w-25,w-50,w-75</code> or <code>w-100</code> class to placeholder
                        class to set different widths to the placeholder.</p>
                    <div class="live-preview">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/ui-placeholders.blade.php ENDPATH**/ ?>