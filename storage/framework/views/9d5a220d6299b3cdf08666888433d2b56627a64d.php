<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.crypto'); ?>
        ...
        <div class="col-xxl-3">
            <div class="card card-height-100">
                <div class="card-header border-0 align-items-center d-flex">
                    ...
                    <div>
                        <div class="dropdown">
                            <button class="btn btn-soft-primary btn-sm shadow-none" data-bs-toggle="dropdown"
                        ...
                        <table class="table table-hover table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$53,914.025</td>
                                    <td>1.25634801</td>
                                    <td><a href="<?php echo e(URL::asset('/apps-crypto-buy-sell')); ?>"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/usdt.svg')); ?>" alt=""
                                                    class="avatar-xxs shadow rounded-circle">
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="me-2">
                                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/doge.svg')); ?>" alt=""
                                                    class="avatar-xxs shadow rounded-circle">
                                            </div>
                                            <div>
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush border-dashed mb-0">
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/btc.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/eth.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/aave.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/doge.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/bnb.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
                        ...
                        <li class="list-group-item d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="<?php echo e(URL::asset('assets/images/svg/crypto-icons/ltc.svg')); ?>" class="avatar-xs shadow rounded-circle"
                                    alt="">
                            </div>
                            <div class="flex-grow-1 ms-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/small/img-1.jpg')); ?>" class="rounded img-fluid shadow" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/small/img-2.jpg')); ?>" class="rounded img-fluid shadow" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/small/img-3.jpg')); ?>" class="rounded img-fluid shadow" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(URL::asset('assets/images/small/img-6.jpg')); ?>" class="rounded img-fluid shadow" style="height: 60px;"
                                alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/dashboard-crypto.blade.php ENDPATH**/ ?>