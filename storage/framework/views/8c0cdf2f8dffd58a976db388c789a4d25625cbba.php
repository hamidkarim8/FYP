<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.nestable-list'); ?>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>nested-list nested-sortable</code> class to list-group class to set a
                        nested list with sortable items.</p>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>nested-list nested-sortable-handle</code> class to list-group class
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>nested-list nested-sortable</code> class to list-group class to set
                        a nested list with sortable items where icons are given within list-group-item.</p>
                        ...
                        <div class="list-group-item nested-1"> <i
                            ...
                            <div class="list-group nested-list nested-sortable">
                                ...
                                <div class="list-group-item nested-2"> <i
                                    ...
                                    <div class="list-group nested-list nested-sortable">
                                        <div class="list-group-item nested-3"><i
                                                class="mdi mdi-image fs-16 align-middle text-info me-2"></i> logo.png</div>
                                    </div>
                                </div>
                                <div class="list-group-item nested-2"> <i
                                ...
                                <div class="list-group-item nested-2"> <i
                                        class="mdi mdi-language-html5 fs-16 align-middle text-danger me-2"></i> index.html
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>nested-list nested-sortable</code> class to list-group class to set
                        a nested list with sortable items where the list is shown with navigation.</p>
                    ...
                    <div class="list-group nested-list nested-sortable">
                        ...
                        <div class="list-group-item nested-1"> <i
                                class="ri-account-circle-line fs-16 align-middle text-primary me-2"></i> Authentication
                            <div class="list-group nested-list nested-sortable">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>nested-list nested-sortable</code> class to list-group class to set
                        a nested list with sortable items where images are attached within a list-group-item div element.
                    </p>
                    <div class="list-group nested-list nested-sortable">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/advance-ui-nestable.blade.php ENDPATH**/ ?>