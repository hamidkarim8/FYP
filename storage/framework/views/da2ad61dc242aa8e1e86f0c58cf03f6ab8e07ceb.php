                            ...
                            <div class="col-xxl-8">
                                <div class="">
                                    <div class="card-header border-0 align-items-center d-flex">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-soft-secondary shadow-none btn-sm">
                                                ALL
                                            </button>
                                            <button type="button" class="btn btn-soft-secondary shadow-none btn-sm">
                                                1M
                                            ...
                                            <button type="button" class="btn btn-soft-primary shadow-none btn-sm">
                                                1Y
                                            </button>
                                        </div>
                                    </div><!-- end card header -->
    ...
    <div class="col-xxl-3 col-lg-6">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <a href="apps-nft-collections" type="button" class="btn btn-soft-primary btn-sm shadow-none flex-shrink-0">
                    See All <i class="ri-arrow-right-line align-bottom"></i>
                </a>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <a href="apps-nft-creators" type="button" class="btn btn-soft-primary btn-sm shadow-none flex-shrink-0">
                    See All <i class="ri-arrow-right-line align-bottom"></i>
                </a>
            </div>
            <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/dashboard-nft.blade.php ENDPATH**/ ?>