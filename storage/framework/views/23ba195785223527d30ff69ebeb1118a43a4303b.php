<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.mailbox'); ?>
            ...
            <div class="p-4 d-flex flex-column h-100">
                ...
                <div class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                    ...
                    <div class="border-top border-top-dashed pt-3 mt-3">
                        <a href="#" class="btn btn-icon btn-sm btn-soft-info shadow-none btn-rounded float-end"><i
                            ...
                            <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                ...
                                <div id="email-topbar-actions">
                                    <div class="hstack gap-sm-1 align-items-center flex-wrap">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm shadow-none fs-16"
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-ghost-secondary btn-icon shadow-none btn-sm fs-16" type="button"
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-ghost-secondary shadow-none btn-icon btn-sm fs-16" type="button"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="pb-4 border-bottom border-bottom-dashed">
                    <div class="row">
                        <div class="col">
                            <div class="">
                                <button type="button"
                                    class="btn btn-soft-danger btn-icon btn-sm fs-16 close-btn-email shadow-none">
                        ...
                        <div class="col-auto">
                            <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                <button type="button"
                                    class="btn btn-ghost-secondary btn-icon btn-sm shadow-none fs-16 favourite-btn active">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-ghost-secondary btn-icon btn-sm shadow-none fs-16" type="button"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="ri-more-2-fill align-bottom"></i>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-end">
                ...
                <div class="mt-auto">
                    <form class="mt-2">
                        <div>
                            ...
                            <textarea class="form-control border-bottom-0 rounded-top rounded-0 border" id="exampleFormControlTextarea1" rows="3"
                                placeholder="Enter message"></textarea>
                            <div class="bg-light px-2 py-1 rouned-bottom border">
                                <div class="row">
                                    <div class="col">
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-sm py-0 fs-15 btn-light shadow-none"
                                    ...
                                    <div class="col-auto">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-sm btn-success shadow-none"><i
                                                    class="ri-send-plane-2-fill align-bottom"></i></button>
                                            <button type="button"
                                                class="btn btn-sm btn-success shadow-none dropdown-toggle dropdown-toggle-split"
            ...
            <div class="card-header align-items-center d-flex bg-primary text-white-50">
                ...
                <div class="flex-shrink-0">
                    <div class="mt-n3 me-n3">
                        <button type="button" class="btn btn-link text-white shadow-none fs-16 text-decoration-none"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-mailbox.blade.php ENDPATH**/ ?>