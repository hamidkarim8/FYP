    ...
    <div class="file-manager-sidebar">
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="mt-auto text-center">
                <img src="<?php echo e(URL::asset('assets/images/task.png')); ?>" alt="Task" class="img-fluid" />
            </div>
        </div>
    </div>
    <!--end side content-->
        ...
        <div class="hstack mb-4">
            ...
            <div class="hstack gap-2">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button class="btn btn-icon fw-semibold shadow-none btn-soft-danger"><i class="ri-arrow-go-back-line"></i></button>
                    <button class="btn btn-icon fw-semibold shadow-none btn-soft-success"><i class="ri-arrow-go-forward-line"></i></button>
                </div>
            </div>
        </div>
                                ...
                                <div data-simplebar style="max-height: 141px">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>
                                            <a class="dropdown-item d-flex align-items-center" href="#">
                                                <div class="avatar-xxs flex-shrink-0 me-2">
                                                    <img src="<?php echo e(URL::asset('assets/images/users/avatar-9.jpg')); ?>" alt="" class="img-fluid rounded-circle" />
                                                </div>
...
<script src="<?php echo e(URL::asset('assets/js/pages/todo.init.js')); ?>"></script>
<script src="<?php echo e(URL::asset('/assets/js/app.min.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-todo.blade.php ENDPATH**/ ?>