    ...
    <div class="col-xxl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">Use the <code>badge-soft-</code> class with the below-mentioned variation to create a softer badge.
                </p>
...
<div class="row">
    <div class="col-xxl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted">Use the <code>badge-outline-</code> class with the below-mentioned variation to create a badge with the outline.
                </p>
                <div class="live-preview">
    ...
    <div class="col-xxl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">Use the <code>rounded-pill badge-soft-</code> class with the below-mentioned variation
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-TESTING\resources\views/ui-badges.blade.php ENDPATH**/ ?>