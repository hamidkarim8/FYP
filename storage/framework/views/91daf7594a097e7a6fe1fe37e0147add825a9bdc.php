            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none"
                        ...
                        <?php break; ?>
                        <?php default: ?>
                            <img src="<?php echo e(URL::asset('/assets/images/flags/us.svg')); ?>" class="rounded " alt="Header Language" height="18">
                    <?php endswitch; ?>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="<?php echo e(url('index/en')); ?>" class="dropdown-item notify-item language py-2" data-lang="en"
                            title="English">
                            <img src="<?php echo e(URL::asset('assets/images/flags/us.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="<?php echo e(url('index/sp')); ?>" class="dropdown-item notify-item language" data-lang="sp"
                            title="Spanish">
                            <img src="<?php echo e(URL::asset('assets/images/flags/spain.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="<?php echo e(url('index/it')); ?>" class="dropdown-item notify-item language" data-lang="it"
                            title="Italian">
                            <img src="<?php echo e(URL::asset('assets/images/flags/italy.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="<?php echo e(url('index/ru')); ?>" class="dropdown-item notify-item language" data-lang="ru"
                            title="Russian">
                            <img src="<?php echo e(URL::asset('assets/images/flags/russia.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="<?php echo e(url('index/ch')); ?>" class="dropdown-item notify-item language" data-lang="ch"
                            title="Chinese">
                            <img src="<?php echo e(URL::asset('assets/images/flags/china.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <a href="<?php echo e(url('index/fr')); ?>" class="dropdown-item notify-item language" data-lang="fr"
                            title="French">
                            <img src="<?php echo e(URL::asset('assets/images/flags/french.svg')); ?>" alt="user-image" class="me-2 rounded" height="18">
...
<?php /**PATH C:\xampp\htdocs\FYP-TESTING\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>