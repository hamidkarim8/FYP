<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.media-object'); ?>
                    ...
                    <div class="live-preview">
                        <div class="d-flex align-items-start text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-sm rounded shadow" alt="...">
                            </div>
                        ...
                        <div class="d-flex align-items-start text-muted mb-4">
                            ...
                            <div class="flex-shrink-0 ms-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" class="avatar-sm rounded shadow" alt="...">
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex align-items-start text-muted mb-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-start text-muted mt-3">
                                    <div class="flex-shrink-0 me-3">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" class="avatar-sm rounded shadow"
                                            alt="...">
                                    </div>
                                    <div class="flex-grow-1">
                                        <h5 class="fs-14">Media heading</h5>
                        ...
                        <div class="d-flex align-items-start text-muted">
                            <div class="flex-shrink-0 me-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" class="avatar-sm rounded shadow" alt="...">
                            </div>
                            <div class="flex-grow-1">
                                <h5 class="fs-14">Media heading</h5>
                                This is some content from a media component. You can replace this with any content and
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        <div class="d-flex align-items-start text-muted mb-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-0">Donec sed odio dui. Nullam quis risus eget urna mollis ornare vel
                                    eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus
                                    mus.</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center text-muted mb-4">
                            <div class="flex-shrink-0 me-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" class="avatar-sm rounded shadow" alt="...">
                            </div>
                        ...
                        <div class="d-flex align-items-end text-muted">
                            <div class="flex-shrink-0 me-3">
                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" class="avatar-sm rounded shadow" alt="...">
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/ui-media.blade.php ENDPATH**/ ?>