<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.ticket-details'); ?>
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-md-auto">
                                        <div class="avatar-md mb-md-0 mb-4">
                                            <div class="avatar-title bg-white rounded-circle">
                                                <img src="<?php echo e(URL::asset('assets/images/companies/img-4.png')); ?>" alt=""
                                                    class="avatar-sm" />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-auto mt-md-0 mt-4">
                                <div class="hstack gap-1 flex-wrap">
                                    ...
                                    <button type="button" class="btn py-0 fs-16 text-body shadow-none" id="settingDropdown"
                ...
                <div class="card-body p-4">
                    ...
                    <div data-simplebar style="height: 300px;" class="px-3 mx-n3">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h5 class="fs-13">Alexis Clarke <small class="text-muted">26 min ago</small>
                                </h5>
                                ...
                                <div class="d-flex mt-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-13">Donald Palmer <small class="text-muted">8 sec
                                                ago</small></h5>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-tickets-details.blade.php ENDPATH**/ ?>