...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row g-4 mb-3">
        <div class="col-sm-auto">
            <div>
                <a href="<?php echo e(URL::asset('/apps-projects-create')); ?>" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add
                    New</a>
            </div>
        </div>
        <div class="col-sm">
                ...
                <div class="card-body">
                    <div class="d-flex flex-column h-100">
                                ...
                                <div class="d-flex gap-1 align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a class="dropdown-item" href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"><i
                                                    class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                View</a>
                                            <a class="dropdown-item" href="<?php echo e(URL::asset('/apps-projects-create')); ?>"><i
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1 fs-15"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-3 mt-n3 mx-n3 bg-soft-danger rounded-top">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h5 class="mb-0 fs-14"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="fs-14 mb-3"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>" class="text-dark">Kanban
                                Board</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>" class="text-dark">Ecommerce
                                app</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>" class="text-dark">Redesign -
                                Landing page</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
        ...
        <div class="col-xxl-3 col-sm-6 project-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3">
                        <h5 class="mb-3 fs-14"><a href="<?php echo e(URL::asset('/apps-projects-overview')); ?>"
                                class="text-dark">Multipurpose landing template</a></h5>
                        <div class="row gy-3">
                            <div class="col-6">
                                <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-projects-list.blade.php ENDPATH**/ ?>