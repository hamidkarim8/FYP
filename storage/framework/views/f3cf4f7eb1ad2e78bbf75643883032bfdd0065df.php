                    ...
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-3">
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-primary shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-success shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-light shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-info shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-secondary shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-warning shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-danger shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown"
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-dark shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false"></button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#">Action</a>
                                    <a class="dropdown-item" href="#">Another action</a>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>btn-lg</code> class to create a large size dropdown button and <code>btn-sm</code> to create a small size dropdown button.</p>
                    <div class="live-preview">
                        <div class="d-flex flex-wrap gap-3 align-items-center">
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-lg btn-light shadow-none dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown"
                            ...
                            <div class="btn-group shadow">
                                ...
                                <button type="button" class="btn btn-sm btn-light dropdown-toggle dropdown-toggle-split shadow-none" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                </button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#">Action</a>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change the position of the dropdown.</p>
                                            ...
                                            <div data-simplebar style="max-height: 300px;" class="pe-2">
                                                ...
                                                <div class="text-reset notification-item d-block dropdown-item">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-1">
                                                            <a href="#!"><h6 class="mt-0 mb-1 fs-13 fw-semibold">Angela Bernier</h6></a>
                                                ...
                                                <div class="text-reset notification-item d-block dropdown-item">
                                                    <div class="d-flex">
                                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>"
                                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                        <div class="flex-1">
                                                            <a href="#!"><h6 class="mt-0 mb-1 fs-13 fw-semibold">Maureen Gibson</h6></a>
                                                            <div class="fs-13 text-muted">
                                                ...
                                                <div class="text-reset notification-item d-block dropdown-item">
                                                    <div class="d-flex">
                                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>"
                                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                        <div class="flex-1">
                                                            <a href="#!"><h6 class="mt-0 mb-1 fs-13 fw-semibold">James Lemire</h6></a>
                                                            <div class="fs-13 text-muted">
                                                                <p class="mb-1">We talked about a project on linkedin.</p>
                                                            </div>
                                                            <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                ...
                                                <div class="text-reset notification-item d-block dropdown-item">
                                                    <div class="d-flex">
                                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>"
                                                            class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                        <div class="flex-1">
                                                            <a href="#!"><h6 class="mt-0 mb-1 fs-13 fw-semibold">Kenneth Brown</h6></a>
                                                            <div class="fs-13 text-muted">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/ui-dropdowns.blade.php ENDPATH**/ ?>