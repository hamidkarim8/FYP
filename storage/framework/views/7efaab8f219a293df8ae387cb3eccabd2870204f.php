                ...
                <div class="card-header border-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <button class="btn btn-success" onClick="deleteMultiple()"><i
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <div class="hstack gap-2 justify-content-center remove">
                                            <button class="btn btn-link link-success fw-medium text-decoration-none"
                                                data-bs-dismiss="modal" d="deleteRecord-close"><i class="ri-close-line me-1 align-middle"></i>
                                                Close</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/apps-tickets-list.blade.php ENDPATH**/ ?>