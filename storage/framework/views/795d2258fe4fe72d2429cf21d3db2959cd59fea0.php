                                                        ...
                                                        <div class="col-10">
                                                            <div class="text-white-50">
                                                                <p class="fs-20 ff-secondary mb-4">"
                                                                    <?php echo e($feedback->message); ?> "</p>

                                                                <div>
                                                                    <h5 class="star-rating">
                                                                        <?php echo e(str_repeat('★', $feedback->stars)); ?></h5>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP\resources\views/index.blade.php ENDPATH**/ ?>