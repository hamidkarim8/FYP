<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('translation.scrollSpy'); ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-spy="scroll"</code> attribute to update links in a
                        navigation list based on the current scroll position. Scroll the area below the navbar and watch the
                        active class
                        change.</p>
                    ...
                    <div class="live-preview">
                        <nav id="navbar-example" class="navbar navbar-light bg-light px-3">
                            <a class="navbar-brand" href="#">
                                <img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>" class="card-logo card-logo-dark" alt="logo dark"
                                    height="14">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-spy="scroll"</code> attribute. Scrollspy also works with
                        nested nav. If a nested nav is active, its parents will also be active. Scroll the area next to the
                        navbar and watch the active class change.</p>
                    <div class="live-preview">
                        <div class="row gy-4">
                            <div class="col-xxl-3">
                                <nav id="navbar-examplenested" class="navbar navbar-light bg-light flex-column">
                                    <a class="navbar-brand mb-2" href="#">
                                        <img src="<?php echo e(URL::asset('assets/images/logo-dark.png')); ?>" class="card-logo card-logo-dark"
                                    ...
                                    <nav class="nav nav-pills flex-column p-3 w-100">
                                        ...
                                        <a class="nav-link active" href="#item-2"><i
                                                class="ri-pencil-ruler-2-line align-middle me-2 fs-16"></i> <span>Base
                                                UI</span></a>
                                        <a class="nav-link" href="#item-3"><i
                                                class="ri-apps-2-line align-middle me-2 fs-16"></i> <span>Apps</span></a>
                                        <nav class="nav nav-pills flex-column">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use <code>data-bs-spy="scroll"</code> attribute. Scrollspy also works with the
                        list-group. Scroll the area next to the list group and watch the active class change.</p>
                    <div class="live-preview">
                        <div class="row gy-4">
                            <div class="col-xxl-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FYP-1\resources\views/advance-ui-scrollspy.blade.php ENDPATH**/ ?>